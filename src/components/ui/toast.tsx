...
export function Toaster() {
  ...
  return (
    <div
      ...
      aria-live="polite"
      className={cn(
        'fixed left-1/2 z-[60] -translate-x-1/2 rounded-lg px-4 py-2 text-sm shadow-lg transition-all duration-300 bottom-[calc(5.5rem+env(safe-area-inset-bottom,0px))] md:bottom-6',
